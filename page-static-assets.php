...
<div class="wrapper module-highlighted-sentence">
	<div class="module-spacer">
		<div class="wrapper-padded">
			<div class="wrapper-padded-more">
				<div class="wrapper-padded-more-924 content-styled">
					<h1>Pagina listing e content<br />
						H1 - Titillium web Bold - 48pt - interlinea 60 - spazio dopo 24</h1>
					<h2>Pagina listing<br />
						H2 - titoli sezioni pagina<br />
						Titillium web Bold - 40pt - interlinea 48 - spazio dopo 24</h2>
					<h2 class="h2-variant">Pagina content<br />
						H2 - content pagine titolo sezione<br />
						Titillium web Bold - 24pt - interlinea 32 - spazio dopo 16</h2>
					<h3>Pagina listing<br />
						H3 - Titolo card listing sottopagine<br />
						Titillium web Bold - 32pt - interlinea 40 - spazio dopo 16</h3>
					<h3 class="h3-variant">Pagina contenth3 - Titolo di paragafo<br />
					...
					<h6>h6 - categorie e cta<br />
						...
						Titillium web Bold - kerning 50 - 14pt - interlinea 20</h6>
					<p>
					...
					<div class="navi">
						navigazione<br />
						Titillium web Semibold - 18pt - interlinea 30
					</div>
					<div class="caption">
						dida - footer - header<br />
						Titillium web Regular - 14pt - interlinea 20
					</div>

					<a href="#" class="arrow-button">Leggi di più</a><br />
					<a href="#" class="square-button green">Label</a><br />
					<a href="#" class="square-button green filled">Label</a><br />
					<a href="#" class="square-button blue">Label</a><br />
					<a href="#" class="square-button blue filled">Label</a><br />
					<a href="#" class="tag-button filled-button">Tag</a>
				</div>
			</div>
		</div>
	</div>
...
<div class="wrapper module-highlighted-sentence">
	<div class="module-spacer">
		<div class="wrapper-padded">
			<div class="wrapper-padded-more">
				<h2>Tipi di card listing</h2>
				<h3>card singoli contenuti</h3>
				<div class="flex-hold flex-hold-3 margins-wide">
					...
					<div class="flex-hold-child card insite">
						<div class="card_inner regular-card">
							...
							<div class="more-info">
								<p>
									<b>Data pubblicazione:</b> 12 febbraio 2020<br />
									<b>Data scadenza:</b> 12 marzo 2020
								</p>
							</div>
						</div>
						<div class="cta-holder">
					...
					<div class="flex-hold-child card insite">
						<div class="card_inner cap-card">
							<div class="category-square title-block cat-fill-a">
								<h3><span>Lorem ipsum dolor sit amen consectetur</span></h3>
							</div>
						</div>
					</div>
					<!-- card singoli contenuti -->
					...
					<!-- card singoli contenuti -->
					<!-- card singoli contenuti -->
					<div class="flex-hold-child card offsite">
						<div class="card_inner cap-card">
					...
					<!-- card singoli contenuti -->
					<!-- card singoli contenuti -->
					<div class="flex-hold-child card warning">
						<div class="card_inner warning-card">
							<span class="icon icon-warning"></span>
							<h5 class="allupper">Attenzione</h5>
							<p>
								Gli uffici saranno chiusi per ristrutturazione fino al 10 aprile 2020
							</p>
						</div>
					</div>
					<!-- card singoli contenuti -->
					<!-- card singoli contenuti -->
					<div class="flex-hold-child card restricted">
						<div class="card_inner warning-card">
							<span class="icon icon-reserved"></span>
							<h5 class="allupper">Servizio riservato</h5>
							<p>
								Attenzione il servizio è riservato ai Comuni della Provincia di Lecco
							</p>
						</div>
					</div>
					<!-- card singoli contenuti -->
