						...
						<?php if ( have_rows( 'global_socials', 'option' ) ) : ?>
							...
							<ul class="inline-socials">
								<?php while ( have_rows( 'global_socials', 'option' ) ) :
									the_row(); ?>
									<li>
										<a href="<?php the_sub_field( 'global_socials_profile_url' ); ?>"
											class="social-icorn <?php the_sub_field( 'global_socials_icon' ); ?>" target="_blank"
		...
		<div class="wrapper-padded">
			<div class="<?php echo $footer_wrapper; ?>">
				...
				<ul class="footer-menu-bottom">
					<li>
						Sito realizzato da <a href="https://www.paperplanefactory.com/" target="_blank">PaperPlane</a> basato su <a
