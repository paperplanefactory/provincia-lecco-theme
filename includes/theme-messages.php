...
function custom_dashboard_help() {
	echo '<a href="http://www.paperplanefactory.com" target="_blank"><img src="' . get_template_directory_uri() . '/assets/images/admin-images/logo-paper.svg" width="200" /></a><h2>Benvenuto nelll&rsquo;area di amministrazione del sito.</h2><p>Il sito <strong>' . get_bloginfo( 'name' ) . '</strong> è basato su <a href="https://wordpress.org/" target="_blank">WordPress</a> e utilizza un tema appositamente creato da <a href="http://www.paperplanefactory.com" target="_blank">PaperPlane Factory.</a><br />
...
<strong>Hai bisogno di aiuto? <a href="mailto:info@paperplanefactory.com">Contattaci</a></strong> via mail tramite il link oppure scrivi a info@paperplanefactory.com</p>';
}
