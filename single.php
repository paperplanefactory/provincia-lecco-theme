          ...
          <div class="flex-hold flex-hold-page-opening">
            <div class="page-opening-left printable">
              ...
              <?php if (get_field('data_di_termine_mandato_politico')): ?>
                <p class="paragraph-variant">
                  Termine mandato:
                  <?php the_field('data_di_termine_mandato_politico'); ?>
                </p>
              <?php endif; ?>
            ...
            <div class="page-index-left no-print">
              <div class="sticky-element sticky-columns-js">
                <button onclick="pageIndexMenuControls(this)"
                  ...
                  aria-expanded="true" aria-label="Apri l'indice dei contenuti" data-collapsed="Apri l'indice dei contenuti"
          ...
          <div class="wrapper-padded-more">
            <div class="listing-box">
              ...
              <div class="flex-hold flex-hold-3 margins-wide grid-separator-2">
                <?php foreach ($my_related_content_progetto as $post):
                  setup_postdata($post);
                  $count_related++; ?>
              ...
              <?php if ($count_related >= 3): ?>
                <div class="aligncenter">
                  <a href="<?php the_field('archives_url_ricerca', 'any-lang'); ?><?php echo $content_argomenti_link; ?>&results_order=title"
                    class="square-button green filled allupper">Altri contenuti correlati</a>
                </div>
              <?php endif; ?>
            </div>
          </div>
  ...
  <?php else: ?>
    <?php if (get_field('related_content_method') != 'no-related'): ?>
          ...
          <div class="wrapper-padded">
            <div class="wrapper-padded-more">
              <div class="listing-box">
                ...
                <div class="flex-hold flex-hold-3 margins-wide grid-separator-2">
                  <?php foreach ($related_content_handpicked as $post):
                    setup_postdata($post); ?>
                    <?php include(locate_template('template-parts/grid/listing-card.php')); ?>
                  <?php endforeach;
                  wp_reset_postdata(); ?>
      ...
      <?php elseif (get_field('related_content_method') === 'organizzazione-related'): ?>
        ...
        $content_argomenti = array(); foreach ($terms_argomenti as $term_argomenti) {
          $content_argomenti[] = $term_argomenti->slug;
        }
        //$content_argomenti = implode(',', $content_argomenti);
          ...
          <div class="wrapper-padded">
            <div class="wrapper-padded-more">
              <div class="listing-box">
                <h2 class="aligncenter aligncenter-notmobile">Contenuti Correlati</h2>
                <div class="flex-hold flex-hold-3 margins-wide grid-separator-2">
                  <?php foreach ($my_related_content as $post):
                    setup_postdata($post); ?>
                    <?php include(locate_template('template-parts/grid/listing-card.php')); ?>
                  <?php endforeach;
                  wp_reset_postdata(); ?>
