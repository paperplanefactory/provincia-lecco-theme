					...
					<div class="avviso-left">
						<div class="avviso-top-padder">
							<div class="padder">
								...
								<h2 class="as-h3 txt-12"><?php the_title(); ?></h2>
								...
								if ( have_rows( 'avviso_gestione_cta_repeater' ) ) : ?>
									<div class="tags-holder">
										<?php while ( have_rows( 'avviso_gestione_cta_repeater' ) ) :
											the_row();
											...
											?>
											<a href="<?php echo $avviso_gestione_cta_url; ?>" target="<?php echo $target; ?>"
												class="square-button green filled">
												<?php the_sub_field( 'avviso_gestione_cta_repeater_testo' ); ?>
											</a>
										<?php endwhile; ?>
									</div>
								<?php endif; ?>
