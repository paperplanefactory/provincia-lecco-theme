      ...
      <div class="module-separator-flex">
        <div class="content-styled">
          <?php if ( get_sub_field( 'module_index_title_in_module' ) == 1 ) : ?>
              <h4 class="lighter-h4"><span class="title-icon icon-attachement"></span><a name="indice-<?php echo $module_count; ?>" class="anchor-head"></a><?php the_sub_field( 'module_index_title' ); ?></h4>
          <?php else : ?>
        ...
        <div class="flex-hold flex-hold-2 margins-wide">
          <?php
          if ( have_rows( 'module_gestione_documenti_repeater' ) ) : while ( have_rows( 'module_gestione_documenti_repeater' ) ) : the_row();
          ...
          <div class="flex-hold-child card insite">
            ...
            <div class="card_inner compact-card">
              <div class="texts-holder compact">
                <h4 class="h4-variant"><?php the_sub_field( 'module_gestione_documenti_repeater_doc_title' ); ?></h4>
