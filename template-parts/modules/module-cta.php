  ...
  <div class="module-separator">
    ...
    <div class="tags-holder">
      ...
      if ( $module_call_to_action_link_type === 'link-interno' ) :
        ...
        ?>
        <?php foreach( $module_call_to_action_link_internal as $post ) : setup_postdata( $post ); ?>
          <?php if ( $module_call_to_action_link_appearence === 'link-button' ) : ?>
            <a href="<?php the_permalink(); ?>" class="square-button green filled" title="<?php the_title(); ?>" aria-label="<?php the_title(); ?>"><?php the_title(); ?></a>
          <?php else : ?>
      ...
      <?php else : ?>
        <?php
        if ( have_rows( 'module_call_to_action_repeater' ) ) : while ( have_rows( 'module_call_to_action_repeater' ) ) : the_row();
        ...
        ?>
        <?php if ( $module_call_to_action_link_appearence === 'link-button' ) : ?>
          <a href="<?php echo $module_call_to_action_repeater_destination; ?>" class="square-button green filled" title="<?php the_sub_field( 'module_call_to_action_repeater_testo' ); ?>" aria-label="<?php the_sub_field( 'module_call_to_action_repeater_testo' ); ?>" target="_blank" rel="nofollow"><?php the_sub_field( 'module_call_to_action_repeater_testo' ); ?></a>
        <?php else : ?>
          <a href="<?php echo $module_call_to_action_repeater_destination; ?>" class="tag-button filled-button" title="<?php the_sub_field( 'module_call_to_action_repeater_testo' ); ?>" aria-label="<?php the_sub_field( 'module_call_to_action_repeater_testo' ); ?>" target="_blank" rel="nofollow"><?php the_sub_field( 'module_call_to_action_repeater_testo' ); ?></a>
        <?php endif; ?>
        <?php endwhile; endif; ?>
      <?php endif; ?>
    </div>
