				...
				<div id="header-structure">
					<div class="logo">
						<a href="<?php echo home_url(); ?>" rel="bookmark"
							title="Homepage | Sito istituzionale della <?php echo get_bloginfo( 'name' ); ?>"
							aria-label="Homepage | Sito istituzionale della <?php echo get_bloginfo( 'name' ); ?>" class="absl"></a>
					</div>
					<div class="side-head">
						<ul>
								...
								<?php while ( have_rows( 'global_socials', 'option' ) ) :
									...
									<li class="header-social">
										<a href="<?php the_sub_field( 'global_socials_profile_url' ); ?>" target="_blank"
											aria-label="Visit <?php the_sub_field( 'global_socials_profile_url' ); ?>" rel="noopener">
							...
							<li class="search-menu">
								<button onclick="openSearch()" class="activate-search activate-search-js button-appearance-normalizer"
									aria-label="Apri/chiudi pannello di ricerca" data-collapsed="Apri pannello di ricerca"
							...
							<li class="hamb-menu">
								<button onclick="hamburgerMenu()" aria-haspopup="true" aria-expanded="false"
									aria-label="Apri/chiudi il menu di navigazione" data-collapsed="Apri il menu di navigazione"
									data-expanded="Chiudi il menu di navigazione" class="hambuger-element ham-activator">
									<span></span>
									<span></span>
									<span></span>
									<span></span>
			...
			<div class="<?php echo $header_wrapper; ?>">
				<div id="header-structure">
					...
					<div class="side-head">
						<ul>
							<li class="search-menu">
								<button onclick="openSearch()" class="activate-search activate-search-js"
									aria-label="Apri/chiudi pannello di ricerca" data-collapsed="Apri pannello di ricerca"
									data-expanded="Chiudi pannello di ricerca">
									<span class="icon-search"></span>
								</button>
					...
					<div class="<?php echo $header_wrapper; ?>">
						<div class="search-overlay-structure">
							<button onclick="closeSearch()"
								...
								aria-label="Chiudi pannello di ricerca"><span class="icon-left-arrow"></span>Cerca</button>
