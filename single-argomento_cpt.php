						...
						<div class="page-opening-left">
							...
							<form action="<?php the_field( 'archives_url_ricerca', 'any-lang' ); ?>"
								...
								<input type="hidden" name="argomenti_tax[]"
									value="<?php echo $argomento_page_listing_term; ?>">
						...
						<div class="page-opening-right">
							<div class="padder">
								...
								if ( $argomento_area_correlata ) :
									...
									<?php foreach ( $argomento_area_correlata as $post ) :
										setup_postdata( $post );
										$compact_card = 1; ?>
			...
			<div class="wrapper-padded-more">
				<div class="listing-box">
					...
					<ul class="flex-hold flex-hold-3 margins-wide grid-separator-2">
						<?php foreach ( $argomenti_in_evidenza as $post ) :
							setup_postdata( $post ); ?>
							<?php include( locate_template( 'template-parts/grid/listing-card.php' ) ); ?>
						<?php endforeach;
						wp_reset_postdata(); ?>
		...
		<div class="wrapper-padded">
			<div class="wrapper-padded-more">
				<div class="listing-box">
					...
					<ul class="flex-hold flex-hold-3 margins-wide grid-separator-2">
						<?php foreach ( $my_three_amministrazione as $post ) :
							setup_postdata( $post ); ?>
							<?php include( locate_template( 'template-parts/grid/listing-card.php' ) ); ?>
						<?php endforeach;
						wp_reset_postdata(); ?>
		...
		<div class="wrapper-padded">
			<div class="wrapper-padded-more">
				<div class="listing-box">
					<h2>Servizi</h2>
					<ul class="flex-hold flex-hold-3 margins-wide grid-separator-2">
						<?php foreach ( $my_three_servizi as $post ) :
							setup_postdata( $post ); ?>
							<?php include( locate_template( 'template-parts/grid/listing-card.php' ) ); ?>
						<?php endforeach;
						wp_reset_postdata(); ?>
		...
		<div class="wrapper-padded">
			<div class="wrapper-padded-more">
				<div class="listing-box">
					<h2>Novità</h2>
					<ul class="flex-hold flex-hold-3 margins-wide grid-separator-2">
						<?php foreach ( $my_three_novita as $post ) :
							setup_postdata( $post ); ?>
							<?php include( locate_template( 'template-parts/grid/listing-card.php' ) ); ?>
						<?php endforeach;
						wp_reset_postdata(); ?>
		...
		<div class="wrapper-padded">
			<div class="wrapper-padded-more">
				<div class="listing-box">
					...
					<ul class="flex-hold flex-hold-3 margins-wide grid-separator-2">
						<?php foreach ( $my_three_documenti as $post ) :
							setup_postdata( $post ); ?>
							<?php include( locate_template( 'template-parts/grid/listing-card.php' ) ); ?>
						<?php endforeach;
						wp_reset_postdata(); ?>
		...
		<div class="wrapper-padded">
			<div class="wrapper-padded-more">
				<div class="listing-box">
					<h2>Progetti</h2>
					<ul class="flex-hold flex-hold-3 margins-wide grid-separator-2">
						<?php foreach ( $my_three_progetti as $post ) :
							setup_postdata( $post ); ?>
							<?php include( locate_template( 'template-parts/grid/listing-card.php' ) ); ?>
						<?php endforeach;
						wp_reset_postdata(); ?>
